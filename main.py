...
class Food:
    def __init__(self):
        x = random.randint(0, (GAME_WIDTH / SPACE_SIZE) - 1) * SPACE_SIZE  # range is x coor. to y coor. 700/50=14
        y = random.randint(0,
                           (GAME_HEIGHT / SPACE_SIZE) - 1) * SPACE_SIZE  # space_size is multiplies to convert to pixels
